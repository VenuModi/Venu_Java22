...
class Labb1 {
    ...
    public void meny() {
        while (true) {
            ...
            switch (menyVal) {
                ...
                case "2" -> minMaxMedel();
                case "3" -> sortering();
                case "4" -> bastaLaddningsTid();
                case "e" -> {
                    System.out.println("Programmet har avslutats");
                    return;
                }
                default -> System.out.println("Varning!! Välj från följande alternativ.");
            }
    ...
    Denna metod sorterar ut alla dessa priser
     från lägsta till högsta och med motsvarande tid.
    */
